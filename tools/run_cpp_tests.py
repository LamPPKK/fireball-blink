...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="fireball-blink-tests-") as temporary:
        cases = {
            ...
            "renderer_cosmetic_style_state_test": [
                "fireball/browser/domain_model.cc",
                "fireball/chromium/renderer_cosmetic_style_state.cc",
                "fireball/components/adblock/profile_policy.cc",
                "fireball/components/navigation/url_cleaner.cc",
                "fireball/components/navigation/document_cosmetic_policy.cc",
            ...
            "browser_cosmetic_document_state_test": [
            ...
            "chromium_subresource_adapter_test": [
                "fireball/browser/domain_model.cc",
                "fireball/chromium/navigation_adapter_contract.cc",
                "fireball/chromium/subresource_adapter_contract.cc",
                "fireball/components/adblock/profile_policy.cc",
                "fireball/components/navigation/url_cleaner.cc",
                "tests/chromium_subresource_adapter_test.cc",
            ],
            "profile_request_policy_bundle_test": [
                "fireball/browser/domain_model.cc",
                "fireball/chromium/profile_request_policy_bundle.cc",
                "fireball/components/adblock/profile_policy.cc",
                "fireball/components/egress/egress_controller.cc",
                "fireball/components/egress/egress_route.cc",
                "fireball/components/navigation/request_policy.cc",
                "fireball/components/navigation/url_cleaner.cc",
                "fireball/components/privacy/network_audit.cc",
                "tests/profile_request_policy_bundle_test.cc",
            ],
